...
//   final LatLng _center = const LatLng(45.764043, 4.835659); // Lyon par exemple
...
//         markers: {
//           Marker(
//             markerId: const MarkerId('sample'),
//             position: _center,
//             infoWindow: InfoWindow(
//               title: AppTranslations.get('sample_property', locale, 'Exemple de propriété'),
//               snippet: AppTranslations.get('sample_address', locale, 'Adresse exemple'),
//             ),
//           ),
//         },
...
//   }
// }
// lib/pages/map_page.dart - Version de test sans clé API
...
//       body: Stack(
//         children: [
//           // Carte statique en attendant Google Maps
//           Container(
...
//                   Text(
//                     AppTranslations.get('map_coming_soon', locale, 'Fonctionnalité carte en cours de développement'),
...
//                   Text(
//                     AppTranslations.get('setup_google_maps', locale, 'Configuration Google Maps en cours...'),
//                     textAlign: TextAlign.center,
//                     style: TextStyle(
//                       fontSize: 14,
...
//           // Boutons de simulation de fonctionnalités
//           Positioned(
//             bottom: 20,
//             right: 20,
//             child: Column(
...
//                       SnackBar(
//                         content: Text(AppTranslations.get('location_simulated', locale, 'Localisation simulée')),
//                       ),
//                     );
//                   },
//                   child: const Icon(Icons.my_location),
...
//                   heroTag: "add_marker",
//                   onPressed: () {
//                     _showAddMarkerDialog(context, locale);
//                   },
...
//   void _showAddMarkerDialog(BuildContext context, Locale locale) {
//     showDialog(
//       context: context,
//       builder: (BuildContext context) {
//         return AlertDialog(
//           title: Text(AppTranslations.get('add_marker', locale, 'Ajouter un marqueur')),
//           content: Text(AppTranslations.get('marker_coming_soon', locale, 'Cette fonctionnalité sera disponible après la configuration de Google Maps')),
//           actions: [
//             TextButton(
